...
//
#line 652 "F:\Documents\Xenko Projects\Asteroids\Asteroids\Asteroids\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_fbcacb5017ae0ae2e0def10f8d8982d6.hlsl"
...
@G    Pixel => 26549fd07b301cb1794a7dd73b5c98ef
//
// Generated by Microsoft (R) HLSL Shader Compiler 6.3.9600.16384
//
//
...
//
#line 681 "F:\Documents\Xenko Projects\Asteroids\Asteroids\Asteroids\Bin\Windows\Debug\log\shader_XenkoForwardShadingEffect_fbcacb5017ae0ae2e0def10f8d8982d6.hlsl"
...
#line 351
  ...
  ishl r6.x, r4.w, l(2)
  ld_indexable(buffer)(float,float,float,float) r6.xyz, r6.xxxx, t3.xyzw  // r6.x <- spotLight1.x; r6.y <- spotLight1.y; r6.z <- spotLight1.z
...
#line 286
  mul r2.x, r2.x, r4.w  // r2.x <- attenuation
  mul r6.xyz, r2.xxxx, r9.xyzx  // r6.x <- streams.lightColor_id39.x; r6.y <- streams.lightColor_id39.y; r6.z <- streams.lightColor_id39.z

#line 432
  dp3 r2.x, r1.xyzx, -r8.xyzx
  max r2.x, r2.x, l(0.000100)  // r2.x <- streams.NdotL_id43
  mul r6.xyz, r2.xxxx, r6.xyzx  // r6.x <- streams.lightColorNdotL_id40.x; r6.y <- streams.lightColorNdotL_id40.y; r6.z <- streams.lightColorNdotL_id40.z
...
#line 268
  ...
  max r7.x, r7.x, l(0.000000)  // r7.x <- normalOffsetScale
  mul r7.x, r0.w, r7.x

#line 318
  mov r8.x, r2.w
  mov r8.yz, r3.xxyx
  mad r1.xyz, r7.xxxx, r2.xyzx, r8.xyzx  // r1.x <- shadowPosition.x; r1.y <- shadowPosition.y; r1.z <- shadowPosition.z

#line 260
  ishl r5.w, r5.w, l(2)
  imad r5.w, r6.w, l(4), r5.w
  dp4 r7.x, r1.xyzw, cb1[r5.w + 28].xyzw  // r7.x <- shadowPosition.x
  dp4 r7.y, r1.xyzw, cb1[r5.w + 29].xyzw  // r7.y <- shadowPosition.y
  dp4 r7.z, r1.xyzw, cb1[r5.w + 30].xyzw  // r7.z <- shadowPosition.z
  dp4 r1.x, r1.xyzw, cb1[r5.w + 31].xyzw  // r1.x <- shadowPosition.w
  div r1.xyz, r7.xyzx, r1.xxxx  // r1.x <- shadowPosition.x; r1.y <- shadowPosition.y; r1.z <- shadowPosition.z
  add r1.z, r1.z, -cb1[44].x  // r1.z <- depthVS

#line 205
  mad r1.xy, r1.xyxx, cb1[27].xyxx, l(0.500000, 0.500000, 0.000000, 0.000000)
  round_ni r7.xy, r1.xyxx  // r7.x <- base_uv.x; r7.y <- base_uv.y
  add r1.xy, r1.xyxx, -r7.xyxx  // r1.x <- s; r1.y <- t
  add r7.xy, r7.xyxx, l(-0.500000, -0.500000, 0.000000, 0.000000)
  mul r7.xy, r7.xyxx, cb1[27].zwzz

#line 218
  mad r7.zw, -r1.yyyx, l(0.000000, 0.000000, 3.000000, 3.000000), l(0.000000, 0.000000, 4.000000, 4.000000)  // r7.w <- uw0; r7.z <- vw0
  mad r8.xy, r1.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000), l(1.000000, 1.000000, 0.000000, 0.000000)  // r8.x <- uw2; r8.y <- vw2
  mad r8.zw, -r1.xxxy, l(0.000000, 0.000000, 2.000000, 2.000000), l(0.000000, 0.000000, 3.000000, 3.000000)
  div r8.zw, r8.zzzw, r7.wwwz
  add r9.xy, r1.xyxx, l(3.000000, 3.000000, 0.000000, 0.000000)
  div r1.xy, r1.xyxx, r8.xyxx
  add r10.xw, r8.zzzw, l(-2.000000, 0.000000, 0.000000, -2.000000)  // r10.x <- u0; r10.w <- v0
  mul r10.yz, r9.yyxy, l(0.000000, 0.142857, 0.142857, 0.000000)  // r10.z <- u1; r10.y <- v1
  add r9.xy, r1.xyxx, l(2.000000, 2.000000, 0.000000, 0.000000)  // r9.x <- u2; r9.y <- v2
  mul r1.x, r7.z, r7.w
  mad r11.xyzw, r10.xwzw, cb1[27].zwzw, r7.xyxy

#line 185
  sample_c_indexable(texture2d)(float,float,float,float) r1.y, r11.xyxx, t4.xxxx, s0, r1.z  // r1.y <- <SampleTextureAndCompare_id80 return value>

#line 227
  mul r8.zw, r7.zzzw, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 185
  sample_c_indexable(texture2d)(float,float,float,float) r5.w, r11.zwzz, t4.xxxx, s0, r1.z  // r5.w <- <SampleTextureAndCompare_id80 return value>

#line 225
  mul r5.w, r5.w, r8.z
  mad r1.x, r1.x, r1.y, r5.w  // r1.x <- shadow

#line 230
  mul r7.zw, r7.zzzw, r8.xxxy
  mov r9.zw, r10.wwwy
  mad r11.xyzw, r9.xzxw, cb1[27].zwzw, r7.xyxy

#line 185
  sample_c_indexable(texture2d)(float,float,float,float) r1.y, r11.xyxx, t4.xxxx, s0, r1.z  // r1.y <- <SampleTextureAndCompare_id80 return value>

#line 226
  mad r1.x, r7.z, r1.y, r1.x
  mad r12.xyzw, r10.xyzy, cb1[27].zwzw, r7.xyxy

#line 185
  sample_c_indexable(texture2d)(float,float,float,float) r1.y, r12.xyxx, t4.xxxx, s0, r1.z

#line 227
  mad r1.x, r8.w, r1.y, r1.x

#line 185
  sample_c_indexable(texture2d)(float,float,float,float) r1.y, r12.zwzz, t4.xxxx, s0, r1.z

#line 228
  mad r1.x, r1.y, l(49.000000), r1.x

#line 231
  mul r8.zw, r8.xxxy, l(0.000000, 0.000000, 7.000000, 7.000000)

#line 185
  sample_c_indexable(texture2d)(float,float,float,float) r1.y, r11.zwzz, t4.xxxx, s0, r1.z

#line 229
  mad r1.x, r8.z, r1.y, r1.x
  mov r10.y, r9.y
  mad r10.xyzw, r10.xyzy, cb1[27].zwzw, r7.xyxy

#line 185
  sample_c_indexable(texture2d)(float,float,float,float) r1.y, r10.xyxx, t4.xxxx, s0, r1.z

#line 230
  mad r1.x, r7.w, r1.y, r1.x

#line 185
  sample_c_indexable(texture2d)(float,float,float,float) r1.y, r10.zwzz, t4.xxxx, s0, r1.z

#line 231
  mad r1.x, r8.w, r1.y, r1.x
  mul r1.y, r8.y, r8.x
  mad r7.xy, r9.xyxx, cb1[27].zwzz, r7.xyxx

#line 185
  sample_c_indexable(texture2d)(float,float,float,float) r1.z, r7.xyxx, t4.xxxx, s0, r1.z  // r1.z <- <SampleTextureAndCompare_id80 return value>
...
#line 416
  mul r1.xyz, r1.xxxx, cb1[26].xyzx
